...
<html lang="en">
  ...
  <body class="bg-white">
    ...
    <form class="well form-horizontal" action="<?php echo base_url();?>welcome/Register " method="post"  id="contact_form">
<fieldset>

<!-- Form Name -->
<legend><center><h2><b>Volunteer Registration </b></h2></center></legend><br>
...
<div class="form-group">
  <label class="col-md-4 control-label" >House Name</label> 
    ...
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input name="hname" placeholder="House Name" class="form-control"  type="text">
    </div>
  </div>
</div>
<div class= "form-group">
...
?>
  ...
  <label class="col-md-4 control-label">District</label>
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
    <select name="distid" class="form-control selectpicker">
...
<div class="form-group">
  ...
  <input name="number" placeholder="(639)" class="form-control" type="text">
    </div>
  </div>
</div>
